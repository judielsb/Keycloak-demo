package game.sandbox.keycloak.builtinwalletauthenticator.util;
...
public class ChallengeUtils {
     ...
     */
    public static boolean recover(String textMessage, String hexStringSignature, String hexStringEthAddress) throws SignatureException, java.security.SignatureException {
