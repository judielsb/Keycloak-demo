...
public class DBUserStorageProviderFactory implements UserStorageProviderFactory<DBUserStorageProvider> {
    ...
    private synchronized ProviderConfig configure(ComponentModel model) {
        ...
        log.infov("Creating configuration for url: url={0}",System.getenv("LEGACY_DB_JDBC_URL") );


        ProviderConfig providerConfig = new ProviderConfig();
        String         user           = System.getenv("LEGACY_DB_USER");
        String         password       = System.getenv("LEGACY_DB_PASSWORD");
        String         url            = System.getenv("LEGACY_DB_JDBC_URL");
    ...
    public List<ProviderConfigProperty> getConfigProperties() {
        return ProviderConfigurationBuilder.create()
                                        ...
                                        //    .add()
                                           ...
                                           .property()
                                           .name("findByWallet")
                                           .label("get user by attribute Wallet")
                                           .helpText(DEFAULT_HELP_TEXT)
                                           .type(ProviderConfigProperty.STRING_TYPE)
                                           .defaultValue("select \"id\"," +
                                                         "            \"username\"," +
