...
public class UserRepository {
    ...
    public Map<String, String> findByWallet(String value){
        return Optional.ofNullable(doQuery(queryConfigurations.findByWallet(), null, this::readMap, value))
                       .orElse(Collections.emptyList())
                       .stream().findFirst().orElse(null);
    }
    
    public Optional<Map<String, String>> findUserByUsername(String username) {
        return Optional.ofNullable(doQuery(queryConfigurations.getFindByUsername(), null, this::readMap, username, username))
                       .orElse(Collections.emptyList())
                       .stream().findFirst();
    }
    ...
    public boolean validateCredentials(String username, String password) {
        String hash = Optional.ofNullable(doQuery(queryConfigurations.getFindPasswordHash(), null, this::readString, username, username)).orElse("");
